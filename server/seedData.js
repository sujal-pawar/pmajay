...
const seedData = async () => {
  try {
    ...
    const userData = [
      ...
      {
        name: 'State SC Corporation Admin (Maharashtra)',
        email: 'sc.corp@maharashtra.gov.in',
        password: '123123',
        role: 'state_sc_corporation_admin',
        jurisdiction: { state: 'Maharashtra', district: 'All' },
        isEmailVerified: true,
      },
      {
        name: 'State Treasury Officer (Maharashtra)',
        email: 'treasury@maharashtra.gov.in',
        password: '123123',
        role: 'state_treasury',
        jurisdiction: { state: 'Maharashtra', district: 'All' },
        isEmailVerified: true,
      ...
      {
        name: 'District PACC Admin (Mumbai)',
        email: 'pacc@mumbai.gov.in',
        password: '123123',
      ...
      {
        name: 'Audit Officer (Maharashtra)',
        email: 'auditor@mah.audit.gov.in',
        password: '123123',
        role: 'auditor_oversight',
        jurisdiction: { state: 'Maharashtra', district: 'All' },
        isEmailVerified: true,
      },
      {
        name: 'Technical Support (PM-AJAY)',
        email: 'tech.support@pmajay.gov.in',
        password: '123123',
        role: 'technical_support_group',
        jurisdiction: { state: 'All', district: 'All' },
        isEmailVerified: true,
      }
    ];
